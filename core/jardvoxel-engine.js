...
export const BLOCK_COLORS = {
  [BLOCKS.STONE]:       [0.50, 0.50, 0.52],
  [BLOCKS.GRASS]:       [0.35, 0.72, 0.25],
  [BLOCKS.DIRT]:        [0.55, 0.40, 0.25],
  [BLOCKS.SAND]:        [0.93, 0.83, 0.55],
  [BLOCKS.WATER]:       [0.15, 0.40, 0.70],
  [BLOCKS.LAVA]:        [0.90, 0.35, 0.05],
  [BLOCKS.SNOW]:        [0.92, 0.92, 0.96],
  [BLOCKS.WOOD]:        [0.45, 0.30, 0.15],
  [BLOCKS.LEAVES]:      [0.15, 0.50, 0.15],
  ...
  [BLOCKS.CACTUS]:      [0.30, 0.55, 0.25],
  [BLOCKS.SANDSTONE]:   [0.88, 0.78, 0.50],
  [BLOCKS.MOSSY_COBBLE]: [0.35, 0.45, 0.30],
  [BLOCKS.PRISMARINE]:  [0.20, 0.60, 0.55],
  [BLOCKS.CLAY]:        [0.70, 0.70, 0.75],
  [BLOCKS.RED_SAND]:    [0.75, 0.40, 0.20],
  [BLOCKS.TERRACOTTA]:  [0.70, 0.45, 0.30],
  [BLOCKS.SNOW_BLOCK]:  [0.92, 0.92, 0.96],
  [BLOCKS.GRAVEL]:      [0.48, 0.45, 0.42],
  [BLOCKS.FERN]:        [0.30, 0.55, 0.20],
  [BLOCKS.DEAD_BUSH]:   [0.50, 0.35, 0.20],
  [BLOCKS.GLASS]:       [0.80, 0.90, 0.95],
  [BLOCKS.BRICKS]:      [0.60, 0.35, 0.30],
  [BLOCKS.ICE]:         [0.60, 0.80, 0.95],
  [BLOCKS.PACKED_ICE]:  [0.55, 0.75, 0.92],
  [BLOCKS.CALCITE]:     [0.85, 0.85, 0.82],
  [BLOCKS.COARSE_DIRT]: [0.50, 0.38, 0.22],
  [BLOCKS.COPPER_ORE]:  [0.72, 0.55, 0.40],
  [BLOCKS.POWDER_SNOW]: [0.88, 0.88, 0.92],
  [BLOCKS.GRANITE]:     [0.62, 0.40, 0.35],
  [BLOCKS.ANDESITE]:    [0.52, 0.52, 0.55],
  [BLOCKS.DIORITE]:     [0.78, 0.75, 0.72],
  [BLOCKS.MOSSY_STONE]: [0.40, 0.48, 0.35],
  [BLOCKS.FLOWER_RED]:  [0.85, 0.25, 0.20],
  [BLOCKS.FLOWER_YELLOW]: [0.90, 0.80, 0.20],
  [BLOCKS.TALL_GRASS]:  [0.38, 0.62, 0.25],
  // SPEC-028: New block colors
  [BLOCKS.BIRCH_WOOD]:     [0.82, 0.78, 0.62],
  [BLOCKS.SPRUCE_WOOD]:    [0.25, 0.18, 0.12],
  [BLOCKS.OAK_LEAVES_DARK]: [0.10, 0.38, 0.10],
  [BLOCKS.MOSS]:           [0.25, 0.45, 0.20],
  [BLOCKS.MYCELIUM]:       [0.55, 0.50, 0.58],
