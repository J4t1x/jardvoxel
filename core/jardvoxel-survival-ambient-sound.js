...
export const AMBIENT_PROFILES = {
  ...
  caves: {
    ambient: [
      { type: 'drip',    vol: 0.07, interval: [3, 8] },
      { type: 'echo',    vol: 0.05, interval: [10, 20] },
      { type: 'creak',   vol: 0.04, interval: [15, 30] },
    ],
  },
  mystic_grove: {
    ambient: [
  ...
  nether: {
    ambient: [
      { type: 'drone',   vol: 0.10, continuous: true, filter: 400 },
      { type: 'lava',    vol: 0.08, continuous: true, filter: 800 },
...
const SOUND_TYPES = {
  ...
  animals:   { freqRange: [300, 800],   durRange: [0.3, 0.8], waveType: 'sawtooth',filter: 1500 },
  ...
  rockfall:  { freqRange: [80, 300],    durRange: [0.5, 1.5], waveType: 'square', filter: 800 },
  frogs:     { freqRange: [400, 900],   durRange: [0.1, 0.3], waveType: 'square', filter: 1200 },
  drip:      { freqRange: [800, 2000],  durRange: [0.05, 0.15],waveType: 'sine',  filter: 3000 },
  crows:     { freqRange: [600, 1200],  durRange: [0.2, 0.5], waveType: 'sawtooth',filter: 1800 },
  ...
  creak:     { freqRange: [150, 400],   durRange: [0.3, 0.8], waveType: 'sawtooth',filter: 800 },
  ...
  chatter:   { freqRange: [400, 1200],  durRange: [0.3, 0.8], waveType: 'sawtooth',filter: 2000 },
  hammer:    { freqRange: [200, 600],   durRange: [0.05, 0.15],waveType: 'square',filter: 1200 },
  laughter:  { freqRange: [500, 1500],  durRange: [0.3, 0.6], waveType: 'sawtooth',filter: 2200 },
  fire:      { freqRange: [100, 400],   durRange: [1, 3],     waveType: 'brown',  filter: 800 },
