...
export const REPAIR_MATERIALS = {
  // Wood tools → planks
  [TOOL_MAP.WOOD_PICKAXE]: MC_BLOCKS.PLANKS,
  [TOOL_MAP.WOOD_AXE]: MC_BLOCKS.PLANKS,
  [TOOL_MAP.WOOD_SHOVEL]: MC_BLOCKS.PLANKS,
  [TOOL_MAP.WOOD_SWORD]: MC_BLOCKS.PLANKS,
  [TOOL_MAP.WOOD_HOE]: MC_BLOCKS.PLANKS,
  // Stone tools → cobblestone
  [TOOL_MAP.STONE_PICKAXE]: MC_BLOCKS.COBBLESTONE,
  [TOOL_MAP.STONE_AXE]: MC_BLOCKS.COBBLESTONE,
  [TOOL_MAP.STONE_SHOVEL]: MC_BLOCKS.COBBLESTONE,
  [TOOL_MAP.STONE_SWORD]: MC_BLOCKS.COBBLESTONE,
  [TOOL_MAP.STONE_HOE]: MC_BLOCKS.COBBLESTONE,
  // Iron tools → iron ingot
  [TOOL_MAP.IRON_PICKAXE]: MC_BLOCKS.IRON_INGOT,
  [TOOL_MAP.IRON_AXE]: MC_BLOCKS.IRON_INGOT,
  [TOOL_MAP.IRON_SHOVEL]: MC_BLOCKS.IRON_INGOT,
  [TOOL_MAP.IRON_SWORD]: MC_BLOCKS.IRON_INGOT,
  [TOOL_MAP.IRON_HOE]: MC_BLOCKS.IRON_INGOT,
  // Diamond tools → diamond ore (simplified)
  [TOOL_MAP.DIAMOND_PICKAXE]: MC_BLOCKS.DIAMOND_ORE,
  [TOOL_MAP.DIAMOND_AXE]: MC_BLOCKS.DIAMOND_ORE,
  [TOOL_MAP.DIAMOND_SHOVEL]: MC_BLOCKS.DIAMOND_ORE,
  [TOOL_MAP.DIAMOND_SWORD]: MC_BLOCKS.DIAMOND_ORE,
  [TOOL_MAP.DIAMOND_HOE]: MC_BLOCKS.DIAMOND_ORE,
};
